 ...
 * @since v1.0.0
 */
public class RpcClientsRegistrar
    ...
    public void registerRpcClients(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        ...
        Map<String, Object> clientsAttrs = metadata.getAnnotationAttributes(EnableRpcClients.class.getName());
    ...
    private void registerRpcClient(BeanDefinitionRegistry registry,
        ...
        String alias = contextId + "RpcClient";
    ...
    private String getClientName(Map<String, Object> client) {
        ...
        throw new IllegalStateException(SystemOutUtils.format("Either 'name' or 'value' must be provided in @{}", RpcClient.class.getSimpleName()));
    }
    ...
    private String getService(Map<String, Object> client) {
        ...
        throw new IllegalStateException(SystemOutUtils.format("Either 'serviceId' or 'name' or 'value' must be provided in @{}", RpcClient.class.getSimpleName()));
    }

    private String getVersion(Map<String, Object> client) {
        String version = (String) client.get("version");

        return StringUtils.hasText(version) ? version : "v1.0.0";
    }

    private String getTargetProxy(Map<String, Object> client) {
        String proxyTarget = (String) client.get("proxyTarget");
